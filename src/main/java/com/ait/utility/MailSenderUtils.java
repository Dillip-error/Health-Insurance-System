...
public class MailSenderUtils {
	...
	public boolean sendUserAccUnlockMail1(CaseWorkerManagementBind form) {
	...
	public boolean sendUserAccUnlockMail2(CaseWorkerManagementBind form) {
		boolean isSent = false;
		try {
	...
	private String getUnlockAccUserBody(CaseWorkerManagementBind form) throws IOException {
